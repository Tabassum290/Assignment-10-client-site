  ...
  const handleDelete = (queryId) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        fetch(
          `https://assignment-11-server-side-ebon.vercel.app/query/${queryId}`,
          {
            method: "DELETE",
          }
        )
          ...
          .catch((error) => {
            ...
            Swal.fire(
              "Error",
              "Failed to delete the Query. Try again later.",
              "error"
            );
          });
      }
  ...
  return (
    <div>
      ...
      <div
        style={{
          backgroundImage:
            "url(https://i.ibb.co/48PqmvN/istockphoto-1670471395-2048x2048.webp)",
